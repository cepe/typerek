...
# Solid Queue's schema (mirrors the gem's db/queue_schema.rb), run against the primary
# database — no separate queue DB. Generated by hand because the install generator
# isn't run in this deployment; kept verbatim so future gem upgrades diff cleanly.
